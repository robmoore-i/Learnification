...
public class LearnificationSchedulerService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        LearnificationRepository learnificationRepository = PersistentLearnificationRepository.loadInstance(androidLogger, new FromFileLearnificationStorage(androidLogger, androidStorage));
