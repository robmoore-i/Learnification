...
import com.rrm.learnification.learningitemseteditor.buttonbinding.EditLearningItemListButtonRole;
...
public class LearningItemListViewAdaptor extends RecyclerView.Adapter<LearningItemListViewAdaptor.ViewHolder> {
    ...
    public LearningItemListViewAdaptor(AndroidLogger logger, LearningItemStash learningItemStash, PersistentLearningItemRepository learningItemRepository,
                                       EditLearningItemListButtonBinding buttonBinding) {
        this.logger = logger;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(v, learningItemStash, buttonBinding);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(EditText listItemView, LearningItemStash learningItemStash, EditLearningItemListButtonBinding buttonBinding) {
            super(listItemView);
        ...
        private void configureListItemSaver() {
            ...
            listItemView.setOnFocusChangeListener((v, hasFocus) -> {
                ...
                if (hasFocus) {
                    ...
                    buttonBinding.bindToRole(EditLearningItemListButtonRole.UPDATE);
                } else {
