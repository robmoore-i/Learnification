...
public class LearnificationNotificationFactory {
    ...
    public LearnificationNotificationFactory(AndroidLogger logger, Context packageContext,
                                             PendingIntentIdGenerator pendingIntentRequestCodeGenerator, NotificationIdGenerator notificationIdGenerator) {
        this.logger = logger;
    ...
    public IdentifiedNotification createLearnification(LearnificationText learnificationText) {
